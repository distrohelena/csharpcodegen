    ...
    public class CPPRuntimeRequirementCatalog {
        ...
        static IEnumerable<CPPRuntimeRequirementDefinition> CreateDefinitions() {
            return new[] {
                ...
                Make("NativeType", "runtime/native_type.hpp", "HE_CPP_REQ_NATIVE_TYPE", "Lightweight managed type-token support without reflection.", CPPFeatureKind.ReflectionLikeRuntime),
                ...
                Make("FileStream", "system/io/file-stream.hpp", "HE_CPP_REQ_FILE_STREAM", "File stream abstraction support for host-backed runtime IO.", CPPFeatureKind.HostFileSystem),
                Make("File", "system/io/file.hpp", "HE_CPP_REQ_FILE", "File abstraction support for host-backed IO.", CPPFeatureKind.HostFileSystem),
                Make("Directory", "system/io/directory.hpp", "HE_CPP_REQ_DIRECTORY", "Directory abstraction support for host-backed existence checks.", CPPFeatureKind.HostFileSystem),
                Make("Path", "system/io/path.hpp", "HE_CPP_REQ_PATH", "Path abstraction support for host-backed path normalization and resolution.", CPPFeatureKind.HostFileSystem),
                Make("AppContext", "system/app_context.hpp", "HE_CPP_REQ_APP_CONTEXT", "Managed AppContext support for executable-base-directory initialization.", CPPFeatureKind.HostFileSystem),
