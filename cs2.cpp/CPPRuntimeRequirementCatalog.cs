    ...
    public class CPPRuntimeRequirementCatalog {
        ...
        static IEnumerable<CPPRuntimeRequirementDefinition> CreateDefinitions() {
            return new[] {
                ...
                Make("BinaryReader", "runtime/io/binary_reader.hpp", "HE_CPP_REQ_BINARY_READER", "Binary reader support for serialized engine data."),
                Make("BinaryWriter", "runtime/io/binary_writer.hpp", "HE_CPP_REQ_BINARY_WRITER", "Binary writer support for serialized engine data."),
                Make("Stream", "runtime/io/stream.hpp", "HE_CPP_REQ_STREAM", "Stream abstraction support for runtime IO."),
                Make("File", "runtime/io/file.hpp", "HE_CPP_REQ_FILE", "File abstraction support for host-backed IO.")
            };
        }
